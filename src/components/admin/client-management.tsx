                    ...
                    {clients.map((client) => (
                      <tr key={client.id} className="border-b border-[#E5E5E5] hover:bg-slate-50 transition-colors">
                        ...
                        <td className="px-4 py-2 text-right space-x-2">
                          <button onClick={() => selectClient(client)} className="p-1.5 text-blue-600 hover:bg-blue-50 rounded transition-colors" title="Edit">
                            <Pencil className="w-4 h-4" />
                          </button>
                          <button onClick={() => handleDelete(client.id)} className="p-1.5 text-red-600 hover:bg-red-50 rounded transition-colors" title="Delete">
