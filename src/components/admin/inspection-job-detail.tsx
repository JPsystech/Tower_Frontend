            ...
            <CardContent>
              {punchPoints.length === 0 ? (
                ...
                <div className="space-y-4">
                  {punchPoints.map(pp => (
                    <div key={pp.id} className="p-4 rounded-md border border-gray-200 bg-white flex flex-col gap-2">
                      <div className="flex justify-between items-start">
                        <div>
                          <h4 className="font-semibold text-sm">Checklist Item #{pp.checklist_item_id}</h4>
